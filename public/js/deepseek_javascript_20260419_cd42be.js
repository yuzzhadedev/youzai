...
async function sendMessage() {
    ...
    // ========== FITUR BARU: USER MESSAGE DENGAN IMAGE DRAFT ==========
    const userMessage = {
    ...
    // ========== FITUR BARU: CLEAR DRAFT ==========
    clearImageDraft();
    
    // ========== FITUR BARU: THINKING INDICATOR ==========
    ...
    try {
        ...
        // ========== FITUR BARU: GUNAKAN callAPI UNIFIED ==========
        let response;
...
async function handleImageUpload(file) {
    ...
    // ========== FITUR BARU: TAMPILKAN SEBAGAI DRAFT, JANGAN LANGSUNG KIRIM ==========
    showImageDraft(file);
...
// ========== FITUR BARU: REMOVE DRAFT BUTTON ==========
...
function init() {
    ...
    console.log('✅ Youz AI v2.5 initialized');
}
